        ...
        body: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(
                'แบบทดสอบนี้ทำขึ้นเพื่อให้มั่นใจว่าคุณสามารถที่จะทำแบบทดสอบ Stroop test ได้อย่างไม่มีเงื่อนไขใด ๆ โดยเป็นการทำเพียงครั้งเดียวหลังการสมัครสมาชิกและจำเป็นต้องให้อนุญาตการเข้าถึงไมโครโฟน  หากต้องการทำแบบทดสอบอีกครั้งสามารถเลือกทำได้ในหน้าโปรไฟล์',
